...
export const recruiter = {
  ...
  'rec.analytics.companyOverview': {
    uz: 'Kompaniya bo‘yicha umumiy ko‘rsatkichlar',
    ru: 'Сводка по компании',
    en: 'Company overview',
  },
  'rec.analytics.views': { uz: 'Ko‘rishlar', ru: 'Просмотры', en: 'Views' },
  'rec.analytics.applications': { uz: 'Arizalar', ru: 'Отклики', en: 'Applications' },
  'rec.analytics.inReview': { uz: 'Ko‘rib chiqilgan', ru: 'Рассмотрены', en: 'In review' },
  'rec.analytics.interviews': { uz: 'Suhbatlar', ru: 'Собеседования', en: 'Interviews' },
  'rec.analytics.offers': { uz: 'Takliflar', ru: 'Офферы', en: 'Offers' },
  'rec.analytics.hired': { uz: 'Ishga olingan', ru: 'Наняты', en: 'Hired' },
  'rec.analytics.rejected': { uz: 'Rad etilgan', ru: 'Отклонены', en: 'Rejected' },
  'rec.analytics.firstResponse': {
    uz: 'Birinchi javob (median)',
    ru: 'Первый ответ (медиана)',
    en: 'First response (median)',
  },
  'rec.analytics.waitingOverSla': {
    uz: '48 soatdan ortiq javobsiz',
    ru: 'Без ответа более 48 часов',
    en: 'Unanswered over 48h',
  },
  'rec.analytics.noResponsesYet': { uz: 'hali javob yo‘q', ru: 'ответов пока нет', en: 'no responses yet' },
  'rec.analytics.underOneHour': { uz: '1 soatdan kam', ru: 'менее часа', en: 'under 1 hour' },
  'rec.analytics.hours': { uz: '{n} soat', ru: '{n} ч', en: '{n} h' },
  'rec.analytics.days': { uz: '{n} kun', ru: '{n} дн', en: '{n} d' },
  'rec.analytics.viewsTrend': {
    uz: 'Ko‘rishlar, so‘nggi {n} kun',
    ru: 'Просмотры за {n} дней',
    en: 'Views, last {n} days',
  },
  'rec.analytics.applicationsTrend': {
    uz: 'Arizalar, so‘nggi {n} kun',
    ru: 'Отклики за {n} дней',
    en: 'Applications, last {n} days',
  },
  'rec.analytics.funnelHint': {
    uz: 'Voronka: har bir bosqichga yetgan nomzodlar (keyingi bosqichlar ham hisobga olinadi).',
    ru: 'Воронка: кандидаты, дошедшие до каждого этапа (последующие этапы учитываются).',
    en: 'Funnel: candidates who reached each stage (later stages count too).',
  },
  'rec.analytics.sources': { uz: 'Arizalar manbai', ru: 'Источники откликов', en: 'Application sources' },
  'rec.analytics.sourceDirect': { uz: 'Sayt (to‘g‘ridan-to‘g‘ri)', ru: 'Сайт (напрямую)', en: 'Site (direct)' },
  'rec.analytics.sourceTelegramChannel': { uz: 'Telegram kanal', ru: 'Telegram-канал', en: 'Telegram channel' },
  'rec.analytics.sourceTelegramBot': { uz: 'Telegram bot', ru: 'Telegram-бот', en: 'Telegram bot' },
  'rec.analytics.sourceTelegram': { uz: 'Telegram', ru: 'Telegram', en: 'Telegram' },
  'rec.analytics.sourcePwa': { uz: 'Ilova (bosh ekran)', ru: 'Приложение (главный экран)', en: 'App (home screen)' },
  'rec.analytics.sourceShareTelegram': {
    uz: 'Ulashilgan havola (Telegram)',
    ru: 'Ссылка из Telegram',
    en: 'Shared link (Telegram)',
  },
  'rec.analytics.sourceShareLink': {
    uz: 'Ulashilgan havola (nusxa)',
    ru: 'Скопированная ссылка',
    en: 'Shared link (copied)',
  },
  'rec.analytics.sourceShareSheet': {
    uz: 'Ulashilgan havola (telefon)',
    ru: 'Ссылка с телефона',
    en: 'Shared link (phone)',
  },
  'rec.analytics.noApplications': { uz: 'Hali ariza yo‘q.', ru: 'Откликов пока нет.', en: 'No applications yet.' },
  'rec.analytics.pickJob': {
    uz: 'Ko‘rsatkichlarni ko‘rish uchun e’lon tanlang.',
    ru: 'Выберите вакансию, чтобы увидеть показатели.',
    en: 'Pick a job to see its numbers.',
  },
  'rec.analytics.loadFailed': {
    uz: 'Analitikani yuklab bo‘lmadi',
