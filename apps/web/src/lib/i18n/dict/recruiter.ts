...
export const recruiter = {
  ...
  'rec.inviteByEmail': {
    uz: 'Email orqali taklif qilish (rekruter hisobi allaqachon bo‘lishi kerak)',
    ru: 'Пригласить по email (аккаунт рекрутера уже должен существовать)',
    en: 'Invite by email (must already be a recruiter account)',
  },
  ...
  'rec.memberInvited': {
    uz: 'Jamoa a’zosi taklif qilindi',
    ru: 'Участник команды приглашён',
    en: 'Team member invited',
  },
  'rec.inviteFailed': {
