...
export const core = {
  ...
  followersCount: { uz: '{n} kuzatuvchi', ru: 'Подписчиков: {n}', en: '{n} followers' },
  share: { uz: 'Ulashish', ru: 'Поделиться', en: 'Share' },
  'share.telegram': { uz: 'Telegramda ulashish', ru: 'Отправить в Telegram', en: 'Share on Telegram' },
  'share.copyLink': { uz: 'Havolani nusxalash', ru: 'Скопировать ссылку', en: 'Copy link' },
  'share.copied': { uz: 'Havola nusxalandi', ru: 'Ссылка скопирована', en: 'Link copied' },
  ...
  clearHotJobsFilter: {
    uz: 'Dolzarb filtrni olib tashlash',
    ru: 'Сбросить фильтр горячих вакансий',
    en: 'Clear hot jobs filter',
  },
